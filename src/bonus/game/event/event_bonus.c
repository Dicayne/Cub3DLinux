...
/*   Updated: 2020/06/30 13:33:03 by vmoreau          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				close_prog(t_cub3d *cub)
{
	...
	free_img_bis(&cub->tex.g_o, cub);
	free_img_bis(&cub->tex.goal, cub);
	free_img_bis(&cub->tex.lifbar, cub);
	free_img_bis(&cub->tex.weap, cub);
	free_img_bis(&cub->tex.y_w, cub);
